  ...
  window.onload = function () {
    var chart2 = new CanvasJS.Chart("chartContainer2",
    {
      ...
      {       
        ...
        legendText: "{indexLabel}",
        dataPoints: [
          {  y: 45, indexLabel: "PRECISION FASTNERS" },
          {  y: 33, indexLabel: "VALVE COMPONENTS" },
          {  y: 16, indexLabel: "PUMP COMPONENTS" },
          {  y: 6, indexLabel: "GENERAL ENGINEERING"},
